      ...
      <div className="container">
        ...
        <div className={styles.navBar}>
          ...
          <nav className={`${styles.nav} navbar navbar-expand-lg navbar-light`}>
            <button
              className={`${styles.navToggler} custom-toggler navbar-toggler`}
              type="button"
            ...
            <div className={`${isNavCollapsed ? "collapse" : ""} navbar-collapse`} id="navbarsExample09">
              <div className={`${styles.navbarMenu} navbar-nav`}>
                ...
                <Link className="nav-item nav-link" to="/properties">
                  properties
                </Link>
                <Link className="nav-item nav-link" to="/deals">
                  hot deals
                </Link>
          ...
          <div className={styles.navBtns}>
            <button className={styles.login} onClick={showModal}>
              login
            </button>
            <button className={styles.sign} onClick={showModal2}>
              sign up
            </button>
          </div>
        </div>
