              ...
              <div className={styles.viewContent}>
                <div className={styles.gallery}>
                  ...
                  <div className={styles.detailsCard}>
                    ...
                    <div
                      className={` ${
                        propAmin.property_amentities && propAmin.community_amentities
                          ? styles.detailsBlock
                          : styles.hide
                      }`}
                    >
                ...
                <div className={styles.detailsSide}>
                  <div className={styles.cardPrice}>
                    ...
                    <ul className={styles.properties}>
                      <li className={el.bedrooms ? null : styles.hide}>
                        <IoBedSharp className={styles.icon} />
                        {el.bedrooms}
                      </li>
                      <li className={el.beathrooms ? null : styles.hide}>
                  ...
                  <div className={styles.cardPrice}>
                    ...
                    <div className={styles.personDetails}>
                      ...
                      <div className={styles.sellerDetails}>
                        ...
                        <span>commerical ID : 235846</span>
                        <br />
                  ...
                  <div className={styles.cardPrice}>
                    ...
                    <ul className={styles.saftyList}>{parse(sellEachAdv?.data?.instructions?.instructions)}</ul>
                  </div>
