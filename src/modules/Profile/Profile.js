...
const Profile = () => {
  ...
  const ProfileLoader = (props) => (
    <ContentLoader speed={1} viewBox="0 0 400 560" {...props} width={400}>
      <circle cx="200" cy="200" r="200" style={{ zIndex: "5000" }} />
      <rect x="100" y="440" rx="0" ry="0" width="200" height="25" />
      <rect x="80" y="495" rx="0" ry="0" width="240" height="15"></rect>
    </ContentLoader>
  );
